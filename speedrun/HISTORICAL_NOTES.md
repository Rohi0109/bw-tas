# Historical speedrun notes

This document preserves earlier experiments and implementation notes. Timing,
defaults, and behavior described below may be outdated. Start with [README.md](README.md)
for current architecture and commands; consult code and native traces for behavior.
...
fixed PLAY lesson uses a capture-calibrated 0.20-second initial guard, while
retaining the proven 0.35-second per-step guard and exact P/L/A/Y tile path.
